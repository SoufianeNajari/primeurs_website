      ...
      <div className="flex items-center justify-between pt-4 border-t border-neutral-200 gap-3 flex-wrap">
        ...
        <div className="flex gap-3">
          <button
            ...
            className="border border-neutral-300 text-neutral-700 px-5 py-3 font-medium uppercase tracking-widest text-[11px] hover:bg-neutral-50 disabled:opacity-50"
          >
          ...
          <button
            type="submit"
            disabled={saving || uploading}
            className="bg-green-primary text-white px-6 py-3 font-medium uppercase tracking-widest text-[11px] hover:bg-green-dark transition-colors disabled:opacity-50 flex items-center gap-2"
          >
